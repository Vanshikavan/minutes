...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="What you get" text3=" Everything you need to create professional UGC ads without design skills or expensive creators." />
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    ...
                    >
                        <div className="p-6 rounded-xl space-y-4 border border-slate-800 bg-slate-950 max-w-82 w-full">
                            {feature.icon}
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    ADminutes helps you skip the creator fees and production delays by turning your vision into scroll-stopping ads instantly.
                </motion.p>
