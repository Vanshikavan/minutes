  ...
  return (
    <div id="pricing" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <SectionTitle
        ...
        text3="Flexible pricing designed for creators, small businesses, and scaling brands. Start free, no credit card required."
      />
      ...
      <div className="flex flex-wrap items-stretch justify-center gap-8 mt-20">
        {pricingData.map((plan: IPricing, index: number) => (
          ...
          <motion.div
            key={index}
            className={`w-72 flex flex-col text-center border border-pink-950 p-6 pb-16 rounded-xl ${
          ...
          >
            ...
            <button
              type="button"
              className={`w-full py-2.5 rounded-md font-medium mt-auto transition-all ${
                plan.mostPopular
