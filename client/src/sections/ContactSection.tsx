...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Ready to create?" text3="Questions about ADminutes? Need help getting started? Our team is here to help you scale your ad creative." />
