        ...
        hover:border-white/20 transition group">
            ...
            <div className="p-4">
                ...
                <div className="flex items-start justify-between gap-4">
                    ...
                    object-cover rounded-md animate-float ml-1" style={{animationDelay:'3s'}}/>
                </div>
                        <h3 className="font-medium txt-lg mb-1">{gen.productName}</h3>
                ...
                {gen.productDescription &&(
                    <div className="mt-3">
                        ...
                        <div className="text-sm text-gray-300 bg-white/3 p-2 rounded-md
                        wrap-break-word">{gen.productDescription}</div>
                    </div>
                )}
